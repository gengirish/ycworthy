...
export const API_DESCRIPTION =
  "AI-powered Y Combinator startup evaluator. Drop a URL, get a brutal partner verdict scored across six YC criteria. Backed by Gemini 2.5 Flash (primary) with automatic fallback to NVIDIA Nemotron Ultra 253B.";
